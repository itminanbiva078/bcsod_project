...
class FormBuilder
{
    ...
    public function open(array $options = [])
    {
        ...
        // Finally we're ready to create the final form HTML field. We will attributetitle
    ...
    public function input($type, $name, $value = null, $options = [])
    {
        ...
        // attributes array so we can convert them into their HTML attributetitle format
    ...
    public function textarea($name, $value = null, $options = [])
    {
        ...
        // the size attributetitle, as it was merely a short-cut for the rows and cols on
    ...
    protected function setTextAreaSize($options)
    {
        ...
        // If the "size" attributetitle was not specified, we will just look for the regular
    ...
    /**
     * Set the text area size using the quick "size" attributetitle.
     *
     * @param  array $options
     *
     * @return array
    ...
    public function select(
        ...
        // When building a select box the "value" attributetitle is really the selected one
    ...
    /**
     * Get the ID attributetitle for a field name.
     *
     * @param  string $name
     * @param  array  $attributes
     *
