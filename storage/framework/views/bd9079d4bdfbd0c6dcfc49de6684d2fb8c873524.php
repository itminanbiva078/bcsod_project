                    ...
                    <header>
                        <ul id="sm_media_tab" class="nav nav-tabs in">
							...
							?>
                             ...
                             <li class="">
                                <a href="#multi_delete_media_tab"
                                   data-toggle="tab"><?php echo e(__("media.medialMultiDelete")); ?></a>
                            </li>
                        </ul>
                    </header>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div id="sm_media_tab_content" class="tab-content bge5 padding-10">
                                <div class="tab-pane fade" id="multi_delete_media_tab">
                                    <?php echo $__env->make(('nptl-admin/common/media/multi_delete'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                 <div class="tab-pane fade in active" id="media_library_tab">
                                    <?php echo $__env->make(('nptl-admin/common/media/files'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
								<?php
								if ($upload)
								{
