    ...
    <div class="d-table w-100 h-100">
        <div class="d-table-row">
            <div class="d-table-cell">
                <img src="<?php echo e(SM::sm_get_the_src(SM::sm_get_site_loading_logo(), 120, 237)); ?>" class="site_logo"
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav nav-social ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="mailto:<?php echo e($email); ?>" title="<?php echo e($email); ?>"><?php echo e($email); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="tel:<?php echo e($mobile); ?>" title="<?php echo e($mobile); ?>"><?php echo e($mobile); ?></a>
                </li>
                <?php if(empty(!SM::smGetThemeOption("social_facebook"))): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(SM::smGetThemeOption("social_facebook")); ?>" target="_blank"
                           title="Follow our facebook page"><i class="fab fa-facebook-f"></i></a>
                    </li>
                <?php endif; ?>
                <?php if(empty(!SM::smGetThemeOption("social_linkedin"))): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(SM::smGetThemeOption("social_linkedin")); ?>"
