    ...
    <div class="jarviswidget" id="wid-add-tag-main" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <div class="col-sm-12">
                        <?php echo $__env->make("nptl-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'tags'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                            <?php echo Form::label('description','Tag Description'); ?>
...
?>
<?php echo $__env->make('nptl-admin/common/common/image_form',['header_name'=>'Tag',
'image'=>$image], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('nptl-admin/common/common/meta_info',['header_name'=>'Tag',
