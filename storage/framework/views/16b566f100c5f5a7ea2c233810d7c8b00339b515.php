...
<?php $__env->startSection('title', 'Social Setting'); ?>
                            ...
                            <div id="sm_media_tab_content" class="tab-content">
                                <div class="tab-pane fade in active" id="site_meta_info">
                                    <form name="save_site_meta" id="save_site_meta" method="post"
                                          action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_meta_info')); ?>"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('site_screenshot') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="hidden" name="site_screenshot" id="site_screenshot_val"
                                                           value="<?php echo e(SM::get_setting_value( 'site_screenshot' )); ?>">
                                                    ...
                                                    <?php if($errors->has('site_screenshot')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('site_screenshot')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('seo_title') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="col-md-10">
                                                    <input name="seo_title" id="seo_title" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('seo_title')!=''? old('seo_title'): stripslashes(SM::get_setting_value('seo_title'))); ?>">
                                            ...
                                            <div class="form-group<?php echo e($errors->has('site_meta_keywords') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="col-md-10">
                                                    <input name="site_meta_keywords" id="meta_key" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('site_meta_keywords')!=''? old('site_meta_keywords'): stripslashes(SM::get_setting_value('site_meta_keywords'))); ?>">
                                            ...
                                            <div class="form-group<?php echo e($errors->has('site_meta_description') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="col-md-10">
                                                    <input name="site_meta_description" id="meta_description"
                                                           ...
                                                           type="text" required=""
                                                           value="<?php echo e(old('site_meta_description')!=''? old('site_meta_description'): stripslashes(SM::get_setting_value('site_meta_description'))); ?>">
                                ...
                                <div class="tab-pane fade" id="fb_api_credential">
                                    <form name="save_fb_credential" id="save_fb_credential" method="post"
                                          action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_fb_credential')); ?>"
                                          class="smart-form">
                                        <?php echo e(csrf_field()); ?>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('fb_app_id') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="fb_app_id" id="fb_app_id" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('fb_app_id')!='' ? old('fb_app_id') : SM::get_setting_value('fb_app_id')); ?>">
                                                    <?php if($errors->has('fb_app_id')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('fb_app_id')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="form-group<?php echo e($errors->has('fb_app_secret') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="fb_app_secret" id="fb_app_secret" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('fb_app_secret')!='' ? old('fb_app_secret') : SM::get_setting_value('fb_app_secret')); ?>">
                                                    <?php if($errors->has('fb_app_secret')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('fb_app_secret')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="gp_api_credential">
                                    <form name="save_gp_credential" id="save_gp_credential" method="post"
                                          action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_gp_credential')); ?>"
                                          class="smart-form">
                                        <?php echo e(csrf_field()); ?>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('gp_client_id') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="gp_client_id" id="gp_client_id" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('gp_client_id')!='' ? old('gp_client_id') : SM::get_setting_value('gp_client_id')); ?>">
                                                    <?php if($errors->has('gp_client_id')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('gp_client_id')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="form-group<?php echo e($errors->has('gp_client_secret') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="gp_client_secret" id="gp_client_secret"
                                                           ...
                                                           type="text" required=""
                                                           value="<?php echo e(old('gp_client_secret')!='' ? old('gp_client_secret') : SM::get_setting_value('gp_client_secret')); ?>">
                                                    <?php if($errors->has('gp_client_secret')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('gp_client_secret')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="tt_api_credential">
                                    <form name="save_tt_credential" id="save_tt_credential" method="post"
                                          action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_tt_credential')); ?>"
                                          class="smart-form">
                                        <?php echo e(csrf_field()); ?>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('tt_api_key') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="tt_api_key" id="tt_api_key" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('tt_api_key')!='' ? old('tt_api_key') : SM::get_setting_value('tt_api_key')); ?>">
                                                    <?php if($errors->has('tt_api_key')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('tt_api_key')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="form-group<?php echo e($errors->has('tt_api_secret') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="tt_api_secret" id="tt_api_secret" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('tt_api_secret')!='' ? old('tt_api_secret') : SM::get_setting_value('tt_api_secret')); ?>">
                                                    <?php if($errors->has('tt_api_secret')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('tt_api_secret')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="li_api_credential">
                                    <form name="save_li_credential" id="save_li_credential" method="post"
                                          action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_li_credential')); ?>"
                                          class="smart-form">
                                        <?php echo e(csrf_field()); ?>
                                            ...
                                            <div class="form-group<?php echo e($errors->has('li_client_id') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="li_client_id" id="li_client_id" class="form-control"
                                                           ...
                                                           value="<?php echo e(old('li_client_id')!='' ? old('li_client_id') : SM::get_setting_value('li_client_id')); ?>">
                                                    <?php if($errors->has('li_client_id')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('li_client_id')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="form-group<?php echo e($errors->has('li_client_secret') ? ' has-error' : ''); ?>">
                                                ...
                                                <div class="input">
                                                    <input name="li_client_secret" id="li_client_secret"
                                                           ...
                                                           type="text" required=""
                                                           value="<?php echo e(old('li_client_secret')!='' ? old('li_client_secret') : SM::get_setting_value('li_client_secret')); ?>">
                                                    <?php if($errors->has('li_client_secret')): ?>
                                                        <span class="help-block">
                                 <strong><?php echo e($errors->first('li_client_secret')); ?></strong>
                              </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
