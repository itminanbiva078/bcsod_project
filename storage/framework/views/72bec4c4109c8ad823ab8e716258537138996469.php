...
{
?>
<tr id="tr_<?php echo e($subscriber->id); ?>">
    <td><label><input type="checkbox" class="smCheckbox subscriber subscriber<?php echo e($subscriber->id); ?>" value="<?php echo e($subscriber->id); ?>"></label></td>
    <td class="subscriberemail<?php echo e($subscriber->id); ?>"><?php echo $subscriber->email; ?></td>
	...
	<?php if ($per != 0): ?>
    <td class="text-center">
        <a href="javascript:void(0)" row="<?php echo e($subscriber->id); ?>"
        ...
        <a href="<?php echo url( config( 'constant.smAdminSlug' ) . '/subscribers/destroy' ); ?>/<?php echo $subscriber->id; ?>"
           ...
           delete_row="tr_<?php echo e($subscriber->id); ?>">
