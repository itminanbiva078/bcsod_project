                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                                ...
                                <form method="get" action="">
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <select name="country" id="country" class="form-control "
											...
											{
											?>
                                            <option value="<?php echo e($country_name); ?>" <?php echo e($country == $country_name ? "selected" : ""); ?>><?php echo $country_name; ?></option>
											<?php
											}
											?>
                                        </select>
                                    ...
                                    <div class="col-md-2 form-group">
                                        ...
                                        <select name="sstatus" id="sstatus" class="form-control ">
                                            ...
                                            <option value="1" <?php echo e($sstatus == '1' ? "selected" : ""); ?>>Subscribed
                                            </option>
                                            <option value="0" <?php echo e($sstatus == '0' ? "selected" : ""); ?>>Unsubscribed
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 form-group">
                            ...
                            <table id="" class="table table-striped table-bordered sm_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                <?php echo $__env->make('nptl-admin.common.subscriber.subscribers', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th>Select</th>
                            ...
                            <?php echo $__env->make('nptl-admin.common.common.pagination_links', ['smPagination'=>$all_subscriber], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <!-- end widget content -->
    ...
    <div class="modal fade" id="sm_mail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <?php echo Form::open(["method"=>"post", "route"=>"offerMail", "id"=>"mailForm"]); ?>

                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span>
                    </button>
                    <h2 class="modal-title" id="myModalLabel"><?php echo e(SM::sm_get_site_name()); ?> Mail Service</h2>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" id="of_message" name="message">ALL <?php echo e(SM::sm_get_site_name()); ?> Products
UP TO 30% OFF</textarea>
                    ...
                    <div class="row">
                        <?php echo $__env->make('nptl-admin/common/common/image_form',['header_name'=>'Offer Title', 'image'=>'', 'grid'=>'col-xs-12 col-sm-12 col-md-12'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
