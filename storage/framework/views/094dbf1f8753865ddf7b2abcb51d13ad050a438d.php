...
<head>
    ...
    <title><?php echo e(SM::sm_get_site_name()); ?></title>
                    ...
                    <tr>
                        <td align="left" valign="middle">
                            <a href="<?php echo e(url("/")); ?>"><img
                                        src="<?php echo url(SM::sm_get_the_src( $footer_logo, 300, 63 )); ?>"
                                        alt="<?php echo $siteName; ?>"> </a>
                        </td>

                        <td align="right" valign="middle">
                            <img src="<?php echo asset('images/header-right-img.png'); ?>" alt="header">
                        </td>
                    </tr>
                </table>
                ...
                <table bgcolor="#f5f5f5"
                    ...
                    <tr>
                        <td align="left" valign="top" style="padding-left: 20px;" class="column">
                            <img style="margin-right: 7px; width: 32px;" src="<?php echo asset('images/icon.png'); ?>" alt="">
                        ...
                        <td align="left" valign="top" class="column">
                            <img style="margin-right: 7px; width: 34px;" src="<?php echo asset('images/info-icon2.png'); ?>"
                                 alt="">
                        ...
                        <td align="left" valign="top" class="column">
                            <img style="margin-right: 4px; width: 34px;" src="<?php echo asset('images/icon3.png'); ?>" alt="">
                            <p style="display: inline-block; font-size: 16px; color: #1d2d5d; margin-bottom: 0; font-weight: 700;">
                                <?php echo e($address); ?>

                                <span style="display: block; font-size: 14px; color: #969696;"><?php echo e($country); ?></span>
                            </p>
                ...
                <table bgcolor="#f5f5f5" style="background: #f5f5f5; padding: 30px 0; border-bottom: 1px solid #dddddd;"
                    ...
                    <tr>
                        <td align="center" valign="middle">
                            <?php if(empty(!SM::smGetThemeOption("social_facebook"))): ?>
                                <a href="<?php echo e(SM::smGetThemeOption("social_facebook")); ?>"
                                   style="padding: 0 7px; display: inline-block">
                                    <img src="<?php echo asset('images/email_image/facebook.png'); ?>" alt="">
                                </a>
                            <?php endif; ?>
                            <?php if(empty(!SM::smGetThemeOption("social_twitter"))): ?>
                                <a href="<?php echo e(SM::smGetThemeOption("social_twitter")); ?>"
                                   style="padding:0 7px; display: inline-block">
                                    <img src="<?php echo asset('images/email_image/twitter.png'); ?>" alt="">
                                </a>
                            <?php endif; ?>
                            <?php if(empty(!SM::smGetThemeOption("social_pinterest"))): ?>
                                <a href="<?php echo e(SM::smGetThemeOption("social_pinterest")); ?>"
                                   style="padding: 0 7px; display: inline-block">
                                    <img src="<?php echo asset('images/email_image/pinterest.png'); ?>" alt="">
                                </a>
                            <?php endif; ?>
                            <?php if(empty(!SM::smGetThemeOption("social_instagram"))): ?>
                                <a href="<?php echo e(SM::smGetThemeOption("social_instagram")); ?>"
                                   style="padding: 0 7px; display: inline-block">
                                    <img src="<?php echo asset('images/email_image/instragram.png'); ?>" alt="">
                                </a>
                            <?php endif; ?>
                            <?php if(empty(!SM::smGetThemeOption("social_youtube"))): ?>
                                <a href="<?php echo e(SM::smGetThemeOption("social_youtube")); ?>"
                                   style="padding: 0 7px; display: inline-block">
                                    <img src="<?php echo asset('images/email_image/youtube.png'); ?>" alt="">
                                </a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" valign="middle" style="padding-top: 20px; padding-bottom: 40px;">
                            <a href="<?php echo e(url('/')); ?>" style="padding:0 10px 0 0; border-right: 1px solid #dddddd;">
                                View in browser
                            </a>
                            <a href="<?php echo url('career'); ?>" style="padding:0 10px; border-right: 1px solid #dddddd;">
                                Careers
                            </a>
                            <a href="<?php echo url('terms-and-conditions'); ?>" style="padding:0 0 0 10px;">
                                Privacy Statement
                            </a>
                        </td>
                    </tr>
