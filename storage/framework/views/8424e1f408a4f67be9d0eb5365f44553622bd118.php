...
<?php $__env->startSection('title',__("setting.setting")); ?>
    ...
    <section id="widget-grid" class="">
        ...
        <div class="row">
            <form name="save_category" id="save_category" method="post"
                  action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_setting')); ?>"
                                ...
                                <fieldset>
                                    <div class="form-group<?php echo e($errors->has('site_name') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="site_name"><?php echo e(__("setting.siteName")); ?></label>
                                        <div class="col-md-10">
                                            <input name="site_name" id="site_name" class="form-control"
                                                   placeholder="<?php echo e(__("setting.siteName")); ?>" type="text" required=""
                                                   value="<?php echo e(old('site_name')!='' ? old('site_name') : SM::get_setting_value('site_name')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('website') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="website"><?php echo e(__("Website")); ?></label>
                                        <div class="col-md-10">
                                            <input name="website" id="website" class="form-control"
                                                   placeholder="<?php echo e(__("Website")); ?>" type="text" required=""
                                                   value="<?php echo e(old('website')!='' ? old('website') : SM::get_setting_value('website')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('shop_url') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="shop_url">Shop Url</label>
                                        <div class="col-md-10">
                                            <input name="shop_url" id="shop_url" class="form-control"
                                                   placeholder="Shop Url" type="text"
                                                   value="<?php echo e(old('shop_url')!='' ? old('shop_url') : SM::get_setting_value('shop_url')); ?>">

                                        </div>
                                    </div>
                                    <div class="form-group<?php echo e($errors->has('tag_line') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="tag_line"><?php echo e(__("setting.tagLine")); ?></label>
                                        <div class="col-md-10">
                                            <input name="tag_line" id="tag_line" class="form-control"
                                                   placeholder="<?php echo e(__("setting.tagLine")); ?>" type="text" required=""
                                                   value="<?php echo e(old('site_name')!='' ? old('site_name') : SM::get_setting_value('tag_line')); ?>">
                                            <?php if($errors->has('site_name')): ?>
                                                <span class="help-block">
                                            <strong><?php echo e($errors->first('tag_line')); ?></strong>
                                        </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group<?php echo e($errors->has('about') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="about"><?php echo e(__("setting.about")); ?></label>
                                        <div class="col-md-10">
                                        <textarea name="about" id="about" class="form-control"
                                                  placeholder="<?php echo e(__("setting.about")); ?>" rows="4" required=""><?php echo e(old('about')!=''? old('about') :SM::get_setting_value('about')); ?>
                                    ...
                                    <div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="address"><?php echo e(__("setting.address")); ?></label>
                                        <div class="col-md-10">
                                        <textarea name="address" id="address" class="form-control"
                                                  placeholder="<?php echo e(__("setting.address")); ?>" rows="4" required=""><?php echo e(old('address')!=''? old('address') :SM::get_setting_value('address')); ?>
                                    ...
                                    <div class="form-group<?php echo e($errors->has('country') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-10">
                                            <input name="country" id="country" class="form-control"
                                                   ...
                                                   value="<?php echo e(old('country')!='' ? old('country') : SM::get_setting_value('country')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="email"><?php echo e(__("setting.primaryEmail")); ?></label>
                                        <div class="col-md-10">
                                            <input name="email" id="email" class="form-control"
                                                   placeholder="<?php echo e(__("setting.primaryEmail")); ?>" type="email" required=""
                                                   value="<?php echo e(old('email')!='' ? old('email') : SM::get_setting_value('email')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('secondary_email') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="secondary_email"><?php echo e(__("setting.secondaryEmail")); ?></label>
                                        <div class="col-md-10">
                                            <input name="secondary_email" id="secondary_email" class="form-control"
                                                   placeholder="<?php echo e(__("setting.secondaryEmail")); ?>" type="email"
                                                   required=""
                                                   value="<?php echo e(old('secondary_email')!='' ? old('secondary_email') : SM::get_setting_value('secondary_email')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('mobile') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="mobile"><?php echo e(__("setting.mobileNo")); ?></label>
                                        <div class="col-md-10">
                                            <input name="mobile" id="mobile" class="form-control"
                                                   placeholder="<?php echo e(__("setting.mobileNo")); ?>" type="text" required=""
                                                   value="<?php echo e(old('secondary_email')!='' ? old('mobile') : SM::get_setting_value('mobile')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('currency') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="currency"><?php echo e(__("Currency")); ?></label>
                                        <div class="col-md-10">
                                            <select class="select2" name="currency" required id="currency">
                                                <option>Select Item</option>
                                                <?php $__currentLoopData = $country_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>" <?php echo e(( $item->id == SM::get_setting_value('currency')) ? 'selected' : ''); ?>> <?php echo e($item->currency_code); ?>
                                    ...
                                    <div class="form-group<?php echo e($errors->has('primary_color') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-10">
                                            <input name="primary_color" id="primary_color"
                                                   ...
                                                   value="<?php echo e(old('primary_color')!='' ? old('primary_color') : SM::get_setting_value('primary_color')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('secondary_color') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                        ...
                                        <div class="col-md-10">
                                            <input name="secondary_color" id="secondary_color"
                                                   ...
                                                   value="<?php echo e(old('secondary_color')!='' ? old('secondary_color') : SM::get_setting_value('secondary_color')); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('favicon') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label"
                                               for="select-1"><?php echo e(__("setting.favicon")); ?></label>
                                        <div class="col-sm-2">
                                            ...
                                            <input input_holder="favicon" img_holder="favicon_ph" is_multiple="0"
                                                   ...
                                                   value="<?php echo e(__("setting.uploadOrSelectFile")); ?>">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('logo') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label" for="logo"><?php echo e(__("setting.logo")); ?></label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group<?php echo e($errors->has('loading_logo') ? ' has-error' : ''); ?>">
                                        <label class="col-md-2 control-label" for="loading_logo"><?php echo e(__("setting.loading_logo")); ?></label>
                                        <div class="col-sm-2">
                                            ...
                                            <input input_holder="loading_logo_val" img_holder="loading_logo_ph" is_multiple="0"
                                                   ...
                                                   class="btn btn-success sm_media_modal_show"
                                                   value="<?php echo e(__("setting.uploadOrSelectFile")); ?>">
                                            <?php if($errors->has('loading_logo')): ?>
                                                <span class="help-block">
                                            <strong><?php echo e($errors->first('loading_logo')); ?></strong>
                                        </span>
                                            <?php endif; ?>
            ...
            <form name="cache_setting" id="save_cache_setting" method="post"
                  action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_cache_setting')); ?>"
                  class="form-horizontal"
                  enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
                            ...
                            <div class="widget-body">
                                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <?php if($errors->has('is_cache_enable')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('is_cache_enable')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group<?php echo e($errors->has('cache_update_time') ? ' has-error' : ''); ?>">
                                    <label class="col-md-4 control-label"
                                    ...
                                    <div class="col-md-8">
                                        <input name="cache_update_time" id="cache_update_time" class="form-control"
                                               ...
                                               required=""
                                               value="<?php echo e(old('cache_update_time')!='' ? old('cache_update_time') : SM::get_setting_value('cache_update_time', 10)); ?>">
                                        <?php if($errors->has('cache_update_time')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('cache_update_time')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
            ...
            <form name="tax_setting" id="save_tax_setting" method="post"
                  action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_tax_setting')); ?>"
                  class="form-horizontal"
                  enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
                            ...
                            <div class="widget-body">
                                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <?php if($errors->has('is_tax_enable')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('is_tax_enable')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group<?php echo e($errors->has('default_tax') ? ' has-error' : ''); ?>">
                                    <label class="col-md-4 control-label"
                                    ...
                                    <div class="col-md-8">
                                        <input name="default_tax" id="default_tax" class="form-control"
                                               ...
                                               required=""
                                               value="<?php echo e(old('default_tax')!='' ? old('default_tax') : SM::get_setting_value('default_tax')); ?>">
                                        <?php if($errors->has('default_tax')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('default_tax')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group<?php echo e($errors->has('default_tax_type') ? ' has-error' : ''); ?>">
                                    <label class="col-md-4 control-label"
                                    ...
                                    <div class="col-md-8">
                                        <select name="default_tax_type" id="default_tax_type" class="form-control"
                                            ...
                                            ?>
                                            <option value="1" <?php echo e($default_tax_type==1 ? "selected" : ""); ?>>Fixed
                                            </option>
                                            <option value="2" <?php echo e($default_tax_type==2 ? "selected" : ""); ?>>Percentage
                                            </option>
                                        </select>
                                        <?php if($errors->has('default_tax_type')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('default_tax_type')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
            ...
            <form name="save_category" id="save_maintenance_setting" method="post"
                  action="<?php echo e(url(config('constant.smAdminSlug').'/setting/save_maintenance_setting')); ?>"
                  class="form-horizontal"
                  enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>
                            ...
                            <div class="widget-body">
                                <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <?php if($errors->has('is_maintenance_enable')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('is_maintenance_enable')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group<?php echo e($errors->has('maintenance_title') ? ' has-error' : ''); ?>">
                                    <label class="col-md-2 control-label"
                                    ...
                                    <div class="col-md-10">
                                        <input name="maintenance_title" id="maintenance_title" class="form-control"
                                               ...
                                               required=""
                                               value="<?php echo e(old('maintenance_title')!='' ? old('maintenance_title') : SM::get_setting_value('maintenance_title')); ?>">
                                        <?php if($errors->has('maintenance_title')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('maintenance_title')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group<?php echo e($errors->has('maintenance_description') ? ' has-error' : ''); ?>">
                                    <label class="col-md-2 control-label"
                                    ...
                                    <textarea name="maintenance_description" id="maintenance_description"
                                              ...
                                              required=""
                                              rows="8"><?php echo e(old('maintenance_description')!='' ? old('maintenance_description') : SM::get_setting_value('maintenance_description')); ?></textarea>
                                        <?php if($errors->has('maintenance_description')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('maintenance_description')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group<?php echo e($errors->has('when_site_will_live') ? ' has-error' : ''); ?>">
                                    <label class="col-md-2 control-label"
                                    ...
                                    <div class="col-md-10">
                                        <input name="when_site_will_live" id="datetimepicker"
                                               ...
                                               value="<?php echo e(old('when_site_will_live')!='' ? old('when_site_will_live') : SM::get_setting_value('when_site_will_live')); ?>">
                                        <span>Server Time Now: <?php echo e(date('Y-m-d H:i:s')); ?></span>
                                        <?php if($errors->has('when_site_will_live')): ?>
                                            <span class="help-block">
                                        <strong><?php echo e($errors->first('when_site_will_live')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
