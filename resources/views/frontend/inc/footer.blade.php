...
<footer class="bg_black">
        ...
        <div class="container m-auto">
            <div class="row footer_row">
                ...
                <div class="col-12 col-lg-8 item">
                    ...
                    <!--<a class="color_white" href="tel:{!! $mobile !!}">{!! $mobile !!}</a>-->
                     <!--<a class="color_white" href="tel:{!! $mobile !!}">{!! $mobile !!}</a><br>-->
                     <!--<a class="color_white" href="tel:647 760 3403">647 760 3403</a>-->

                    <!--<br /><br />-->
                    <span class="color_white"> {!! $address !!}</span>
                     <br /><br />
                    <!--<a class="color_white" href="mailto:{!! $email !!}">{!! $email !!}</a>-->
                </div>
    ...
    <div class="footer_last bg_gray_dark pt-3 pb-3">
        <div class="container">
            <div class="row">
                <div class="col-12 color_white" style="margin:0; text-align:center;"><p style="margin:0;"> {{ SM::smGetThemeOption("copyright") }}  </p>
